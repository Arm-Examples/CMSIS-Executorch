...
torch::executor::Tensor & any_dims_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<torch::executor::ArrayRef<int64_t>> dim, bool keepdim, torch::executor::Tensor & out);
...
torch::executor::Tensor & argmax_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<int64_t> dim, bool keepdim, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_ARGMIN
torch::executor::Tensor & argmin_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<int64_t> dim, bool keepdim, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & as_strided_copy_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, torch::executor::ArrayRef<int64_t> size, torch::executor::ArrayRef<int64_t> stride, std::optional<int64_t> storage_offset, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & _cdist_forward_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & x1, const torch::executor::Tensor & x2, double p, std::optional<int64_t> compute_mode, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & clamp_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, const std::optional<torch::executor::Scalar> & min, const std::optional<torch::executor::Scalar> & max, torch::executor::Tensor & out);
torch::executor::Tensor & clamp_tensor_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, const std::optional<torch::executor::Tensor> & min, const std::optional<torch::executor::Tensor> & max, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_CLONE
torch::executor::Tensor & clone_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<torch::executor::MemoryFormat> memory_format, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_CLONE_DIM_ORDER
torch::executor::Tensor & _clone_dim_order_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, bool non_blocking, std::optional<torch::executor::ArrayRef<int64_t>> dim_order, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & convolution_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & weight, const std::optional<torch::executor::Tensor> & bias, torch::executor::ArrayRef<int64_t> stride, torch::executor::ArrayRef<int64_t> padding, torch::executor::ArrayRef<int64_t> dilation, bool transposed, torch::executor::ArrayRef<int64_t> output_padding, int64_t groups, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_CONVOLUTION_BACKWARD
::std::tuple<torch::executor::Tensor &,torch::executor::Tensor &,torch::executor::Tensor &> convolution_backward_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & grad_output, const torch::executor::Tensor & input, const torch::executor::Tensor & weight, std::optional<torch::executor::ArrayRef<int64_t>> bias_sizes, torch::executor::ArrayRef<int64_t> stride, torch::executor::ArrayRef<int64_t> padding, torch::executor::ArrayRef<int64_t> dilation, bool transposed, torch::executor::ArrayRef<int64_t> output_padding, int64_t groups, torch::executor::ArrayRef<bool> output_mask, torch::executor::Tensor & out0, torch::executor::Tensor & out1, torch::executor::Tensor & out2);
#endif
...
torch::executor::Tensor & cumsum_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, int64_t dim, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
#endif
...
#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_DEVICE_COPY
torch::executor::Tensor & _h2d_copy_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, torch::executor::Tensor & out);
torch::executor::Tensor & _d2h_copy_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & div_scalar_mode_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, const torch::executor::Scalar & other, std::optional<torch::executor::string_view> rounding_mode, torch::executor::Tensor & out);
...
torch::executor::Tensor & div_out_mode(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, const torch::executor::Tensor & other, std::optional<torch::executor::string_view> rounding_mode, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & empty_out(torch::executor::KernelRuntimeContext & context, torch::executor::ArrayRef<int64_t> size, std::optional<torch::executor::MemoryFormat> memory_format, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_EMPTY_DIM_ORDER
torch::executor::Tensor & _empty_dim_order_out(torch::executor::KernelRuntimeContext & context, torch::executor::ArrayRef<int64_t> size, std::optional<torch::executor::ArrayRef<int64_t>> dim_order, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & full_like_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, const torch::executor::Scalar & fill_value, std::optional<torch::executor::MemoryFormat> memory_format, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & index_Tensor_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, torch::executor::ArrayRef<std::optional<torch::executor::Tensor>> indices, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_INDEX_PUT
torch::executor::Tensor & index_put_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, torch::executor::ArrayRef<std::optional<torch::executor::Tensor>> indices, const torch::executor::Tensor & values, bool accumulate, torch::executor::Tensor & out);
torch::executor::Tensor & index_put_(torch::executor::KernelRuntimeContext & context, torch::executor::Tensor & self, torch::executor::ArrayRef<std::optional<torch::executor::Tensor>> indices, const torch::executor::Tensor & values, bool accumulate);
#endif
...
torch::executor::Tensor & logit_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<double> eps, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & mean_dim_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<torch::executor::ArrayRef<int64_t>> dim, bool keepdim, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
torch::executor::Tensor & mean_dtype_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
#endif
...
::std::tuple<torch::executor::Tensor &,torch::executor::Tensor &,torch::executor::Tensor &> _native_batch_norm_legit_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const std::optional<torch::executor::Tensor> & weight, const std::optional<torch::executor::Tensor> & bias, torch::executor::Tensor & running_mean, torch::executor::Tensor & running_var, bool training, double momentum, double eps, torch::executor::Tensor & out, torch::executor::Tensor & save_mean, torch::executor::Tensor & save_invstd);
::std::tuple<torch::executor::Tensor &,torch::executor::Tensor &,torch::executor::Tensor &> _native_batch_norm_legit_no_stats_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const std::optional<torch::executor::Tensor> & weight, const std::optional<torch::executor::Tensor> & bias, bool training, double momentum, double eps, torch::executor::Tensor & out, torch::executor::Tensor & save_mean, torch::executor::Tensor & save_invstd);
::std::tuple<torch::executor::Tensor &,torch::executor::Tensor &,torch::executor::Tensor &> _native_batch_norm_legit_no_training_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const std::optional<torch::executor::Tensor> & weight, const std::optional<torch::executor::Tensor> & bias, const torch::executor::Tensor & running_mean, const torch::executor::Tensor & running_var, double momentum, double eps, torch::executor::Tensor & out0, torch::executor::Tensor & out1, torch::executor::Tensor & out2);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_NATIVE_DROPOUT
::std::tuple<torch::executor::Tensor &,torch::executor::Tensor &> native_dropout_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, double p, std::optional<bool> train, torch::executor::Tensor & out0, torch::executor::Tensor & out1);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_NATIVE_GROUP_NORM
::std::tuple<torch::executor::Tensor &,torch::executor::Tensor &,torch::executor::Tensor &> native_group_norm_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const std::optional<torch::executor::Tensor> & weight, const std::optional<torch::executor::Tensor> & bias, int64_t N, int64_t C, int64_t HxW, int64_t group, double eps, torch::executor::Tensor & out0, torch::executor::Tensor & out1, torch::executor::Tensor & out2);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_NATIVE_LAYER_NORM
::std::tuple<torch::executor::Tensor &,torch::executor::Tensor &,torch::executor::Tensor &> native_layer_norm_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, torch::executor::ArrayRef<int64_t> normalized_shape, const std::optional<torch::executor::Tensor> & weight, const std::optional<torch::executor::Tensor> & bias, double eps, torch::executor::Tensor & out0, torch::executor::Tensor & out1, torch::executor::Tensor & out2);
#endif
...
torch::executor::Tensor & prod_int_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, int64_t dim, bool keepdim, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
torch::executor::Tensor & prod_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & repeat_interleave_Tensor_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & repeats, std::optional<int64_t> output_size, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & slice_copy_Tensor_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, int64_t dim, std::optional<int64_t> start, std::optional<int64_t> end, int64_t step, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_SLICE_SCATTER
torch::executor::Tensor & slice_scatter_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, const torch::executor::Tensor & src, int64_t dim, std::optional<int64_t> start, std::optional<int64_t> end, int64_t step, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & sum_dim_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<torch::executor::ArrayRef<int64_t>> dim, bool keepdim, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & to_copy_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, bool non_blocking, std::optional<torch::executor::MemoryFormat> memory_format, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_TO_DIM_ORDER_COPY
torch::executor::Tensor & _to_dim_order_copy_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, bool non_blocking, std::optional<torch::executor::ArrayRef<int64_t>> dim_order, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & upsample_bilinear2d_vec_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, std::optional<torch::executor::ArrayRef<int64_t>> output_size, bool align_corners, std::optional<torch::executor::ArrayRef<double>> scale_factors, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_UPSAMPLE_BILINEAR2D_AA
torch::executor::Tensor & _upsample_bilinear2d_aa_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, torch::executor::ArrayRef<int64_t> output_size, bool align_corners, std::optional<double> scales_h, std::optional<double> scales_w, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_UPSAMPLE_NEAREST2D
torch::executor::Tensor & upsample_nearest2d_vec_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, std::optional<torch::executor::ArrayRef<int64_t>> output_size, std::optional<torch::executor::ArrayRef<double>> scale_factors, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_VAR
torch::executor::Tensor & var_correction_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<torch::executor::ArrayRef<int64_t>> dim, const std::optional<torch::executor::Scalar> & correction, bool keepdim, torch::executor::Tensor & out);
torch::executor::Tensor & var_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<torch::executor::ArrayRef<int64_t>> dim, bool unbiased, bool keepdim, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_PORTABLE_VAR_MEAN
::std::tuple<torch::executor::Tensor &,torch::executor::Tensor &> var_mean_correction_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & self, std::optional<torch::executor::ArrayRef<int64_t>> dim, const std::optional<torch::executor::Scalar> & correction, bool keepdim, torch::executor::Tensor & out0, torch::executor::Tensor & out1);
#endif
...
torch::executor::Tensor & dequantize_per_tensor_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, double scale, int64_t zero_point, int64_t quant_min, int64_t quant_max, torch::executor::ScalarType dtype, std::optional<torch::executor::ScalarType> out_dtype, torch::executor::Tensor & out);
torch::executor::Tensor & dequantize_per_tensor_tensor_args_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & scale, const torch::executor::Tensor & zero_point, int64_t quant_min, int64_t quant_max, torch::executor::ScalarType dtype, std::optional<torch::executor::ScalarType> out_dtype, torch::executor::Tensor & out);
torch::executor::Tensor & dequantize_per_channel_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & scales, const std::optional<torch::executor::Tensor> & zero_points, int64_t axis, int64_t quant_min, int64_t quant_max, torch::executor::ScalarType dtype, std::optional<torch::executor::ScalarType> out_dtype, torch::executor::Tensor & out);
...
torch::executor::Tensor & quantized_embedding_byte_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & weight, const torch::executor::Tensor & weight_scales, const std::optional<torch::executor::Tensor> & weight_zero_points, int64_t weight_quant_min, int64_t weight_quant_max, const torch::executor::Tensor & indices, torch::executor::Tensor & out);
torch::executor::Tensor & quantized_embedding_byte_dtype_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & weight, const torch::executor::Tensor & weight_scales, const std::optional<torch::executor::Tensor> & weight_zero_points, int64_t weight_quant_min, int64_t weight_quant_max, const torch::executor::Tensor & indices, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_QUANTIZED_EMBEDDING2B
torch::executor::Tensor & quantized_embedding_2bit_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & weight, const torch::executor::Tensor & weight_scales, const std::optional<torch::executor::Tensor> & weight_zero_points, int64_t weight_quant_min, int64_t weight_quant_max, const torch::executor::Tensor & indices, torch::executor::Tensor & out);
torch::executor::Tensor & quantized_embedding_2bit_dtype_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & weight, const torch::executor::Tensor & weight_scales, const std::optional<torch::executor::Tensor> & weight_zero_points, int64_t weight_quant_min, int64_t weight_quant_max, const torch::executor::Tensor & indices, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_QUANTIZED_EMBEDDING4B
torch::executor::Tensor & quantized_embedding_4bit_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & weight, const torch::executor::Tensor & weight_scales, const std::optional<torch::executor::Tensor> & weight_zero_points, int64_t weight_quant_min, int64_t weight_quant_max, const torch::executor::Tensor & indices, torch::executor::Tensor & out);
torch::executor::Tensor & quantized_embedding_4bit_dtype_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & weight, const torch::executor::Tensor & weight_scales, const std::optional<torch::executor::Tensor> & weight_zero_points, int64_t weight_quant_min, int64_t weight_quant_max, const torch::executor::Tensor & indices, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_QUANTIZED_MIXED_LINEAR
torch::executor::Tensor & quantized_mixed_linear_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & weight, const torch::executor::Tensor & weight_scales, const std::optional<torch::executor::Tensor> & weight_zero_points, std::optional<torch::executor::ScalarType> dtype, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_QUANTIZED_MIXED_MM
torch::executor::Tensor & quantized_mixed_mm_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & weight, const torch::executor::Tensor & weight_scales, const std::optional<torch::executor::Tensor> & weight_zero_points, torch::executor::Tensor & out);
#endif
...
#ifdef RTE_ML_EXECUTORCH_OP_CORTEX_M_QUANTIZED_ACTIVATION
torch::executor::Tensor & quantized_activation_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & lut, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & quantized_avg_pool2d_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, torch::executor::ArrayRef<int64_t> kernel_size, torch::executor::ArrayRef<int64_t> stride, torch::executor::ArrayRef<int64_t> padding, int64_t zero_point, int64_t multiplier, int64_t shift, const torch::executor::Tensor & scratch, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & quantized_conv2d_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & weight, const std::optional<torch::executor::Tensor> & bias, torch::executor::ArrayRef<int64_t> stride, torch::executor::ArrayRef<int64_t> padding, torch::executor::ArrayRef<int64_t> dilation, int64_t input_offset, int64_t output_offset, const torch::executor::Tensor & requantize_multipliers, const torch::executor::Tensor & requantize_shifts, int64_t activation_min, int64_t activation_max, const torch::executor::Tensor & scratch, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_CORTEX_M_QUANTIZED_DEPTHWISE_CONV2D
torch::executor::Tensor & quantized_depthwise_conv2d_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & weight, const std::optional<torch::executor::Tensor> & bias, torch::executor::ArrayRef<int64_t> stride, torch::executor::ArrayRef<int64_t> padding, torch::executor::ArrayRef<int64_t> dilation, int64_t depth_multiplier, int64_t input_offset, int64_t output_offset, const torch::executor::Tensor & requantize_multipliers, const torch::executor::Tensor & requantize_shifts, int64_t activation_min, int64_t activation_max, const torch::executor::Tensor & scratch, torch::executor::Tensor & out);
#endif

#ifdef RTE_ML_EXECUTORCH_OP_CORTEX_M_QUANTIZED_LINEAR
torch::executor::Tensor & quantized_linear_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & weights, const std::optional<torch::executor::Tensor> & bias, const std::optional<torch::executor::Tensor> & kernel_sum, int64_t input_offset, int64_t filter_offset, int64_t output_offset, torch::executor::ArrayRef<int64_t> requantize_multipliers, torch::executor::ArrayRef<int64_t> requantize_shifts, int64_t activation_max, int64_t activation_min, torch::executor::Tensor & out);
#endif
...
torch::executor::Tensor & quantized_transpose_conv2d_out(torch::executor::KernelRuntimeContext & context, const torch::executor::Tensor & input, const torch::executor::Tensor & weight, const std::optional<torch::executor::Tensor> & bias, torch::executor::ArrayRef<int64_t> stride, torch::executor::ArrayRef<int64_t> padding, torch::executor::ArrayRef<int64_t> output_padding, torch::executor::ArrayRef<int64_t> dilation, int64_t input_offset, int64_t output_offset, const torch::executor::Tensor & requantize_multipliers, const torch::executor::Tensor & requantize_shifts, int64_t activation_min, int64_t activation_max, const torch::executor::Tensor & scratch, const torch::executor::Tensor & output_scratch, torch::executor::Tensor & out);
#endif
...
Kernel(
	...
	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
        ...
        internal::EventTracerProfileOpScope event_tracer_op_scope(context.internal_event_tracer(), "native_call__h2d_copy.out");
        EXECUTORCH_SCOPE_PROF("native_call__h2d_copy.out");
        torch::executor::native::_h2d_copy_out(context, self_base, out_base);
...
Kernel(
	...
	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
        ...
        internal::EventTracerProfileOpScope event_tracer_op_scope(context.internal_event_tracer(), "native_call__d2h_copy.out");
        EXECUTORCH_SCOPE_PROF("native_call__d2h_copy.out");
        torch::executor::native::_d2h_copy_out(context, self_base, out_base);
...
#endif // RTE_ML_EXECUTORCH_OP_PORTABLE_DEVICE_COPY
...
#endif // RTE_ML_EXECUTORCH_OP_CORTEX_M_QUANTIZED_ACTIVATION
...
Kernel(
	...
	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
        ...
        cortex_m::native::quantized_avg_pool2d_out(context, input_base, kernel_size_list_out, stride_list_out, padding_list_out, zero_point_base, multiplier_base, shift_base, scratch_base, out_base);
